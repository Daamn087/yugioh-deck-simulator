...
<template>
  <div class="animate-fade-in space-y-8 pb-24 lg:pb-0">
    ...
    <nav class="lg:hidden flex p-1 bg-surface-card rounded-xl border border-border-primary">
      <button 
    ...
    <div class="lg:hidden fixed bottom-1 left-4 right-4 p-4 bg-bg-dark/95 backdrop-blur-md border border-border-primary rounded-2xl z-50 shadow-2xl">
