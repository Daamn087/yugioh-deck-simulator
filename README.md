...
- **YDK Deck Import**: Import decks from YDK files exported from DuelingBook, YGOPro, EDOPro, or other deck builders.
...
You can import decks from YDK files exported from DuelingBook, YGOPro, EDOPro, or other deck builders. YDK is the industry-standard format for Yu-Gi-Oh! deck sharing.

### Exporting from DuelingBook
1. Open your deck on DuelingBook
2. Click "Export Deck"
3. Select "YDK File"
4. The file will download to your computer (e.g., `my_deck.ydk`)

### Importing into the Simulator
1. Click "Choose File" in the "Import Deck from YDK" section
2. Select your YDK deck file
3. Click "Import"
4. The deck will be automatically loaded with all card counts

**Note:** YDK files contain card passcodes which are automatically resolved to card names using the YGOProDeck API.
